...
public class TransactionManagerConfig {
    ...
    private static final String AOP_POINTCUT_EXPRESSION = "execution (* com.relic.service..*.*(..))";
    ...
    public TransactionInterceptor txAdvice() {
        ...
        Map<String, TransactionAttribute> txMap = new HashMap<String, TransactionAttribute>(16);
